...
export function Hero() {
  return (
    <section id="top" className="mx-auto max-w-5xl px-6 pt-14 sm:px-8 sm:pt-20">
      ...
      <div id="about" className="mt-12 grid grid-cols-1 gap-12 sm:mt-16 sm:grid-cols-[1fr_260px] sm:gap-14">
        <div>
        ...
        <div className="sm:justify-self-end">
          <div className="border border-brass/40 p-2">
            <div className="relative aspect-[4/5] w-full overflow-hidden bg-paper-alt sm:w-[240px]">
              <Image
                src="/offiong2.jpeg"
                alt={person.name}
                fill
